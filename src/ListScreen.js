...
const ShoeList = [{"id":"0", "name":"Kyrie 6", "price":"$130.00"},{"id":"1", "name":"ZK 2K", "price":"$200.00"},
{"id":"2", "name":"Kyrie Flytrap", "price":"$148.00"},{"id":"3", "name":"Adidas", "price":"$50.00"}]
...
const ListScreen =({navigation})=>{
    return(
        <View style={{flex:1, padding:20}}>
            ...
            <View>
               <View style={{width:"65%", height:"59%", backgroundColor:"turquoise", marginTop:20, borderRadius:10, padding:10}}>
